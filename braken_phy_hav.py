...
os.system(f"singularity exec docker://staphb/mafft:latest mafft --addfragments {current_dir}/output/extract/sum_consensus.fa {current_dir}/reference/hav_align/hav_all_aln > {current_dir}/output/extract/mafft_genotype_msa")
